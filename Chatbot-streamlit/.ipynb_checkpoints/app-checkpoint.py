...
def main():
    ...
    <style>
        .top-bar {
            background-color: #e6ffe6;  /* Faint green color */
            color: #5C31FF;
            padding: 10px;
            font-size: 10px;
            text-align: left;
...
""", unsafe_allow_html=True)
    ...
    st.markdown("""
        ...
        <div class="top-bar">
            <img src="https://www.nvidia.com/content/nvidiaGDC/us/en_US/about-nvidia/legal-info/logo-brand-usage/_jcr_content/root/responsivegrid/nv_container_392921705/nv_container/nv_image.coreimg.100.850.png/1703060329053/nvidia-logo-vert.png" class="logo-img">
        </div>
        """, unsafe_allow_html=True
    )
